...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/dashboard">Dashborad</a></li>
            <li class="menu-item hidden"><a href="/eligibility">Eligibility</a></li>            
...
<div class="container">
    ...
    <?php if(session()->getFlashdata('success')): ?>
        <div class="alert alert-success hideMe"><?= session()->getFlashdata('success') ?></div>
    <?php endif; ?>
    <form action="/student/saveMarks" method="post" enctype="multipart/form-data">
    <div class="row">
      <div class="col-25">
        <label for="mark_10th">10th Grade Mark:</label>
      </div>
      <div class="col-75">
        <input type="text" name="mark_10th" value="<?= esc($student['mark_10th']) ?>" required>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="mark_12th">12th Grade Mark:</label>
      </div>
      <div class="col-75">
        <input type="text" name="mark_12th" value="<?= esc($student['mark_12th']) ?>" required>
      </div>
    </div>

    <div class="row">
      <div class="col-25">
        <label for="certificate_10th">Upload 10th Certificate:</label>
      </div>
      <div class="col-75">
        <input type="file" name="certificate_10th" accept=".pdf, .docx, .jpg, .png" >
        <i><?= esc($student['certificate_10th']) ?></i>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="certificate_12th">Upload 12th Certificate:</label>
      </div>
      <div class="col-75">
        <input type="file" name="certificate_12th" accept=".pdf, .docx, .jpg, .png" >
        <i><?= esc($student['certificate_12th']) ?></i>
      </div>
    </div>
    <div class="row">
